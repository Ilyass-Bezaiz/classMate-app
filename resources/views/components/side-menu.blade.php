    ...
    <aside id="separator-sidebar" class="w-60 h-screen bg-white dark:bg-gray-800 transition-transform hidden sm:block"
        ...
        <div class="h-full px-6 py-6 overflow-y-auto">
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="#"
                        class="flex items-center py-2 px-5 text-[#5A6ACF] rounded-[30px] bg-[#707FDD] bg-opacity-10 group">
                        <svg class="w-5 h-5 text-[#5A6ACF] transition duration-75 " aria-hidden="true"
                ...
                <li>
                    <a href="#"
                        class="flex items-center py-2 px-5 text-gray-900 rounded-[30px] dark:text-white hover:bg-[#707FDD] hover:bg-opacity-10 dark:hover:bg-gray-700 group">
