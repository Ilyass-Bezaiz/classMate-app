<div x-data="window.themeSwitcher()" x-init="switchTheme()" @keydown.window.tab="switchOn = false"
    ...
    <svg wire:transition.in x-show="!switchOn" @click="switchOn = true; switchTheme()"
        class="w-6 h-6 cursor-pointer text-gray-800" xmlns="http://www.w3.org/2000/svg"
    ...
    <svg wire:transition.in x-show="switchOn" @click="switchOn = false; switchTheme()" class="w-6 h-6 cursor-pointer"
