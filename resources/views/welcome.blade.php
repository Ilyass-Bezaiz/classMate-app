...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body >
        ...
        <div class="h-screen w-screen p-6 lg:p-8 flex flex-col items-center justify-start gap-6">
                ...
                <div
                    ...
                    <div class="contentBx">
                        ...
                        <div class="btnBx flex flex-col w-fit text-center m-auto gap-1">
                            ...
                            <a href="#"
                                class="text-indigo-600  font-semibold opacity-0 translate-y-[50px] duration-200 hover:underline">Demande Compte</a>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="contentBx">
                        ...
                        <div class="btnBx flex flex-col w-fit text-center m-auto gap-1">
                            ...
                            <a href="#"
                                class="text-orange-600  font-semibold opacity-0 translate-y-[50px] duration-200 hover:underline">Demande compte</a>
                        </div>
                    </div>
                </div>
