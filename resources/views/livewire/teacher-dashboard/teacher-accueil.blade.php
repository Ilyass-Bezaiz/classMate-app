        ...
        {{-- <div class="flex-1 bg-white dark:bg-gray-800 rounded-[30px] p-6 flex-shrink-0">
          ...
          <div class="mt-6">
            @foreach ($teachers as $teacher)
              <div
                class="flex justify-between items-center rounded-md mt-2 p-2 border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                <div class="flex items-center gap-3">
                  ...
                  <a wire:navigate href="{{ route('professeur.profile', $teacher->teacher->user->id) }}"
                    class="dark:text-white text-sm">{{ $teacher->teacher->user->name }}</a>
                </div>
