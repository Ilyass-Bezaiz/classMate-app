    ...
    <tbody>
      @foreach ($professeurs as $professeur)
        <tr class="h-20 bg-white dark:bg-gray-800">
          ...
          <td class="">{{ $professeur->module->major->department->name }}</td>
          <td class="">{{ $professeur->module->major->name }}</td>
            ...
            <a wire:navigate href="{{ route('professeur.profile', $professeur->user->id) }}">
              <svg class="cursor-pointer dark:fill-gray-700" width="35" height="36" viewBox="0 0 35 36"
                ...
                <path
                  ...
                  fill="#707FDD" />
                <defs>
                  <filter id="filter0_d_29_1282" x="0" y="0" width="35" height="36" filterUnits="userSpaceOnUse"
