                ...
                <div class="w-3/5 flex flex-col">
                    ...
                    <div class="h-24">
                        ...
                        <x-input type="email" wire:model="email" type="email" name="email"
                            placeholder="exemple@etu.uae.ac.ma" class="text-sm w-11/12 h-11" />
                    ...
                    <div class="h-24">
                        <x-label for="classe">Affecter une
                            classe</x-label>
                        <x-select wire:model='classe' name="classe" class="text-sm w-11/12 h-11">
                            <x-slot name="options">
