  ...
  <div class="flex flex-col gap-7">
      ...
      <div class=" rounded-[30px] p-8 bg-white dark:bg-gray-800 dark:text-gray-100">
        ...
        <div class="flex items-center gap-4 flex-col flex-1">
          ...
          <div class="flex justify-center items-center gap-4">
            <div>
              <label class="font-semibold text-sm text-gray-400 ml-4" for="class">Classe</label>
              <div class="flex justify-center items-center bg-violet-100 dark:bg-gray-700 w-72 h-11 rounded-[30px]">
                <p class="text-[#707FDD] font-semibold cursor-pointer text-sm">{{ $class->name }}</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div
                ...
                <p class="text-gray-800 dark:text-gray-200 text-sm">{{ $class->major->department->name }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="flex justify-center items-center gap-4">
            ...
            <div>
              ...
              <label class="font-semibold text-sm text-gray-400 ml-4" for="students_number">Nombre d'etudiants</label>
              <div
                class="flex justify-center items-center bg-violet-100 dark:bg-gray-700 w-72 h-11 rounded-[30px] text-center align-middle">
    ...
    <div class="flex flex-col gap-5">
      <div class="flex gap-4 items-center px-2 py-3 border-b border-[#c1c1c1]">
        ...
        <div class="bg-white text-[#707FDD] dark:bg-gray-800  rounded-full px-2 py-1">{{ $class->students->count() }}
        </div>
      </div>
      <div>
            ...
            @foreach ($students as $student)
              <tr wire:key={{ $student->id }} class="h-20 bg-white dark:bg-gray-800">
                ...
                <td class="w-16 rounded-r-[30px] text-end fill-none ">
                  <a wire:navigate href="{{ route('etudiants.show', $student->user->id) }}">
                    <svg class="cursor-pointer dark:fill-gray-700" width="35" height="36" viewBox="0 0 35 36"
                      ...
                      <defs>
                        <filter id="filter0_d_29_1282" x="0" y="0" width="35" height="36"
                          ...
                          <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_29_1282" />
                          <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_29_1282" result="shape" />
                        </filter>
                      </defs>
                    </svg>
                  </a>
