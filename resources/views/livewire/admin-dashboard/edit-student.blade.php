            ...
            <div class="flex flex-col w-3/4 items-center">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col justify-center items-center gap-6">
                        ...
                        <hr class="w-16 h-px border-none bg-violet-50 dark:bg-gray-700">
                        <div class="flex flex-col">
                            <label class="font-semibold text-sm text-gray-400 ml-4" for="classe">Affecter une
                                classe</label>
                            <select wire:model='classe'
                                class="w-72 h-11 rounded-[30px] text-center text-sm pl-4 bg-violet-100 border-gray-400  dark:bg-gray-700 dark:text-gray-100"
                                name="classe">
