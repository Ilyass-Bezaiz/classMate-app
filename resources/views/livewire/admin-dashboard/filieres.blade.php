        ...
        <tbody>
            @foreach ($filieres as $filiere)
                <tr wire:key={{ $filiere->id }} class="h-20 bg-white dark:bg-gray-800">
                    ...
                    <td class="">
                        @if ($editingFiliereId === $filiere->id)
                            <select wire:model="editingFiliereDep"
