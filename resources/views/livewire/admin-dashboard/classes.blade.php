    ...
    <tbody>
      @foreach ($classes as $classe)
        <tr wire:key={{ $classe->id }} class="h-20 bg-white dark:bg-gray-800">
          ...
          <td class="w-16 rounded-r-[30px] cursor-pointer text-end fill-none dark:fill-gray-700">
            <a wire:navigate href="{{ route('classe.show', $classe->id) }}">
              <svg width="35" height="36" class="cursor-pointer dark:fill-gray-700" viewBox="0 0 35 36"
                xmlns="http://www.w3.org/2000/svg">
